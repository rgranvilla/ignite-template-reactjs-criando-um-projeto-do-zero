  ...
  return (
    <div className={styles.postContainer}>
      ...
      <div className={styles.banner}>
        <img src="/image1.png" alt="Eat Sleep Code Repeat" />
      </div>
      <section className={styles.contentContainer}>
        ...
        <div className={styles.postStatus}>
          ...
          <div className={styles.postDuration}>
            <FiClock />
            <span>4 min</span>
          </div>
        </div>
        <article className={styles.postArticle}>
          ...
          <p>
            ...
            facilisis nulla pretium consectetur.<strong>Nunc congue.</strong>{' '}
          </p>
          <p>
          ...
          <p>
            ...
            dictum porttitor urna. Phasellus mollis turpis id suscipit dapibus.
            In dolor.
          </p>
          <p>
          ...
          <p>
            ...
            sapien, et scelerisque leo. Donec eu nisi at magna tristique luctus
            vel at turpis. Nam vestibulum ornare ex cursus vulputate. In
            elementum tellus at sapien bibendum, id maximus mauris convallis.
            Donec facilisis porta lobortis. Vivamus mauris diam, pretium ac
            dolor.
          </p>
          <p>
